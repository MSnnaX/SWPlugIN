...
namespace MSnnaXSwAddIn
{
    ...
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmpHad.CreateFileFromResourceBitmap("MSnnaXSwAddIn.ToolbarL.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmpHad.CreateFileFromResourceBitmap("MSnnaXSwAddIn.ToolbarS.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmpHad.CreateFileFromResourceBitmap("MSnnaXSwAddIn.MainIconL.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmpHad.CreateFileFromResourceBitmap("MSnnaXSwAddIn.MainIconS.bmp", thisAssembly);
